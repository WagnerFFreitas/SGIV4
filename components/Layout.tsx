...
import { dbService, supabase } from '../services/databaseService';
        ...
        <div className="h-full flex flex-col p-4">
          ...
          <div className="mt-auto border-t border-slate-100 pt-4">
            ...
            <div className={`flex items-center gap-2 px-4 py-2 mb-4 rounded-xl ${dbStatus === 'online' ? 'bg-emerald-50 text-emerald-700' : 'bg-rose-50 text-rose-700'}`}>
              ...
              {!isCollapsed && <span className="text-[10px] font-black uppercase">{dbStatus === 'online' ? 'Supabase Online' : 'Cloud Offline'}</span>}
            </div>
