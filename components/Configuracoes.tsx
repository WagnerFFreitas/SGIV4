        ...
        <div className="space-y-6">
          <div className="bg-white rounded-[2.5rem] border border-amber-200 shadow-sm overflow-hidden flex flex-col lg:flex-row justify-between items-center gap-8 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 p-8">
              ...
              <button className="bg-white border-2 border-slate-900 text-slate-900 px-8 py-4 rounded-2xl font-black text-[11px] tracking-widest uppercase hover:bg-slate-50 transition-all flex items-center justify-center gap-3">
